...
(define (sport-preset context preset . args)
                    ...
                    (let1 f (safer-read-from-string (cgi-get-parameter "costff" params :default "length"))
                      (cond [(symbol? f)
                            ...
                            [else
                             ...
                             (apply sport-preset (cons context (cdr f)))]))
                  `(result
                    (itdRouteList
...
(define (create-context al)
  (let1 al (merge-headers `((osrm-service . ((bicycle . ("localhost:5000" "/viaroute"))
                            ...
                            (presets . ((alpineClimbing . ((vstd . 4.2) (profile . foot)))
                                        (alpineTour . ((vstd . 4.2) (profile . foot)))
                                        (canyoning . ((vstd . 4.2) (profile . foot)))
                                        (carriageRideTour . ((vstd . 6) (profile . foot)))
                                        (cityTrail . ((vstd . 4.2) (profile . foot)))
                                        (cycling . ((vstd . 15) (profile . bicycle)))
                                        (eBikeCyclingTour . ((vstd . 15) (profile . bicycle)))
                                        (hikingTourTrail . ((vstd . 4.2) (profile . foot)))
                                        (horsebackRidingTour . ((vstd . 5) (profile . foot)))
                                        (iceClimbing . ((vstd . 2.5) (profile . foot)))
                                        (iceTour . ((vstd . 2.5) (profile . foot)))
                                        (inlineSkating . ((vstd . 10) (profile . foot)))
                                        (kayak . ((vstd . 7) (profile . foot)))
                                        (longDistanceCyclingTrack . ((vstd . 4.2) (profile . foot)))
                                        (longDistanceHikingTrail . ((vstd . 4.2) (profile . foot)))
                                        (mountainbiking . ((vstd . 12) (profile . mtb)))
                                        (mountaineering . ((vstd . 3.5) (profile . foot)))
                                        (nordicwalkingTrail . ((vstd . 5) (profile . foot)))
                                        (pilgrimTrack . ((vstd . 4.2) (profile . foot)))
                                        (racingBike . ((vstd . 20) (profile . bicycle)))
                                        (running . ((vstd . 7) (profile . foot)))
                                        (skiFreeride . ((vstd . 4) (profile . foot)))
                                        (skiTransit . ((vstd . 4) (profile . foot)))
                                        (skijoering . ((vstd . 5) (profile . foot)))
                                        (skitour . ((vstd . 4) (profile . foot)))
                                        (skitrailCrosscountry . ((vstd . 5) (profile . foot)))
                                        (sledging . ((vstd . 4) (profile . foot)))
                                        (sleigh . ((vstd . 4) (profile . foot)))
                                        (snowshoehiking . ((vstd . 4) (profile . foot)))
                                        (themeTrail . ((vstd . 4.2) (profile . foot)))
                                        (trailRunning . ((vstd . 7) (profile . foot)))
                                        (transalpMountainbiking . ((vstd . 11) (profile . mtb)))
                                        (viaferrata . ((vstd . 3) (profile . foot)))
                                        (waterHiking . ((vstd . 3) (profile . foot)))
                                        (winterHiking . ((vstd . 4.2) (profile . foot)))
